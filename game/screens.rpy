...
screen quick_menu():
    ...
    if quick_menu:
        ...
        hbox:
            ...
            textbutton _("Mission Log") action ShowMenu('history')
...
screen history():
    ...
    use game_menu(_("Mission Log"), scroll=("vpgrid" if gui.history_height else "viewport"), yinitial=1.0, spacing=gui.history_spacing):
...
style confirm_frame:
    background Frame([ "gui/confirm_frame.png", "gui/frame.png"], gui.frame_borders, tile=gui.frame_tile)
    padding gui.confirm_frame_padding.padding
    xalign .5
    yalign .5
